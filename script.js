document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      const fieldLabel = label ? label.textContent.replace('*', '').trim() : name;
      ...
      if (field.minLength && field.minLength > 0 && value.length < field.minLength) {
        showFieldError(field, fieldLabel + ' must be at least ' + field.minLength + ' characters.');
        return false;
      }

      if (type === 'tel' && value !== '' && !/^[+\d\s\-().]{7,20}$/.test(value)) {
    ...
    contactForm.addEventListener('input', function (e) {
      const field = e.target;
      if (field.matches('input, textarea, select') && field.classList.contains('field-error')) {
        validateField(field);
      }
    });
  ...
  if (animatedElements.length > 0) {
    ...
    if (!document.getElementById('scroll-animation-styles')) {
      ...
      styleSheet.textContent = [
        '.animate-hidden { opacity: 0; transition: opacity 0.6s ease, transform 0.6s ease; }',
        '.fade-in.animate-hidden { transform: none; }',
        '.fade-in-up.animate-hidden { transform: translateY(30px); }',
        '.fade-in-down.animate-hidden { transform: translateY(-30px); }',
        '.fade-in-left.animate-hidden { transform: translateX(-30px); }',
        '.fade-in-right.animate-hidden { transform: translateX(30px); }',
        '[data-animate].animate-hidden { transform: translateY(20px); }',
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '5f4f1296-9f2b-4b7b-9492-dde2e74f0352',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '5f4f1296-9f2b-4b7b-9492-dde2e74f0352';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '5f4f1296-9f2b-4b7b-9492-dde2e74f0352';
